defmodule Issues.TableFormatter do
  ...
  identified by each header.

  Each hear identifies a column and those columns
  are extracted and printed from the rows.

  We calculate the width of each column to fit the
  ...
  of columns, return a list containinf lists of the data
  in each column.
  ...
  @doc """
  Return a binary (string) version of our parameter. ## Examples
  ...
  It is a string of hyphens, with + signs where the
  vertical bar between the columns goes.
